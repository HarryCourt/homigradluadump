-- "addons\\solid_map_vote\\lua\\mapvote_config.lua"
...
SolidMapVote[ 'Config' ][ 'Map Button Size' ] = 0.25
...
SolidMapVote[ 'Config' ][ 'Missing Image' ] = 'https://rate.space-host.ru/hom/bruh.png'
