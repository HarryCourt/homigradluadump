-- "addons\\tools_keypad\\lua\\weapons\\gmod_tool\\stools\\keypad_willox.lua"
...
if CLIENT then
	local function ResetSettings(ply)
		...
		ply:ConCommand("keypad_willox_length_granted 5")
	...
	function TOOL.BuildCPanel(CPanel)
		...
		local granted = vgui.Create("DForm")
			...
			granted:NumSlider("Hold Length:", "keypad_willox_length_granted", 5, 5, 2)
