-- "addons\\advancedsentinelsystem\\lua\\effects\\eff_baku_impactor_sentinel.lua"
...
function EFFECT:Init(data)
	...
	for i = 1, ___x do
		...
		if(___x > 7 && i > 4) then
			...
			part:SetEndAlpha( 0 );
			part:SetStartSize( math.random(2,8) );
			part:SetEndSize( 0 );
			part:SetRoll( 0 );
...
function EFFECT:Render()
	...
	//wlacz jak podpalajace ma byc dol
