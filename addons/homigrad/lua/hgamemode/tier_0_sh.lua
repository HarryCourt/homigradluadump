-- "addons\\homigrad\\lua\\hgamemode\\tier_0_sh.lua"
...
if CLIENT then
	hook.Add("BodyCam","Force",function()

	end)
else
	COMMANDS.bodycam = {function(ply,args)
		SetGlobalBool("BodyCamForce",tonumber(args[1]) > 0)
		PrintMessage(3,GetGlobalBool("BodyCamForce"))
	end}
end