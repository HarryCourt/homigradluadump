-- "addons\\homigrad\\lua\\hgamemode\\src\\roundsystem\\levels\\tier_1_jailbreak\\init_cl.lua"
...
function jailbreak.HUDPaint(white2)
    if #team.GetPlayers(2) == 0 then
        draw.SimpleText(L("jailbreak_minonect"),"H.12",ScrW() / 2,ScrH() / 2 - 250,white2,TEXT_ALIGN_CENTER)
    elseif #team.GetPlayers(1) == 0 then
        draw.SimpleText(L("jailbreak_minonet"),"H.12",ScrW() / 2,ScrH() / 2 - 250,white2,TEXT_ALIGN_CENTER)
    end
...
function jailbreak.ScoreboardBuild(panel,list)
    ...
    function button:Paint(w,h)
        ...
        draw.SimpleText(L("jailbreak_openclose"),"H.18",w / 2,h / 2,white,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
    end
    ...
    /*function button:Paint(w,h)
        ...
        draw.SimpleText("Гилт : " .. tostring(GetGlobalBool("JailBreakGuilt")),"H.18",w / 2,h / 2,white,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
    end
    ...
    function button:Paint(w,h)
        ...
        draw.SimpleText(L("jailbreak_randomjoin") .. tostring(GetGlobalBool("JailBreakRandom")),"H.18",w / 2,h / 2,white,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
    end
