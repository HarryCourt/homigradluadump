-- "addons\\homigrad\\lua\\hgamemode\\src\\roundsystem\\levels\\homicide\\contr_sh.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local CLASS = player.RegClass("contr")

CLASS.weapons = {"weapon_radio","med_band_big","med_kit","med_painkiller","med_adrenaline","weapon_handcuffs","weapon_taser","weapon_hg_flashbang"}
CLASS.main_weapon = {"wep_m4a1"}
CLASS.secondary_weapon = {"wep_glock"}
...
function CLASS:On()
	...
	JMod.EZ_Equip_Armor(self,"ent_jack_gmod_ezarmor_azimutb",subColor2)
	JMod.EZ_Equip_Armor(self,"ent_jack_gmod_ezarmor_bastionshield",subColor3)
	JMod.EZ_Equip_Armor(self,"ent_jack_gmod_ezarmor_tacticalsport",subColor3)
