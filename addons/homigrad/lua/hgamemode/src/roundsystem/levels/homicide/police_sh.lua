-- "addons\\homigrad\\lua\\hgamemode\\src\\roundsystem\\levels\\homicide\\police_sh.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local CLASS = player.RegClass("police")

CLASS.weapons = {"weapon_radio","med_band_big","med_kit","med_painkiller","weapon_handcuffs","weapon_taser","weapon_hg_flashbang","weapon_police_bat"}
...
function CLASS:On()
	...
	JMod.EZ_Equip_Armor(self,"ent_jack_gmod_ezarmor_thorcrv",color)
