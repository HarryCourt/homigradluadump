-- "addons\\homigrad\\lua\\hinit\\ent_jack_gmod_ezresource_sh.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
﻿local ENT = oop.Reg("ent_jack_gmod_ezresource",{"base_entity","item_resource"})
...
ENT.itemType = "resource"
ENT.WaitCupboard = true
---
...
if SERVER then
	...
	function ENT:OnInvPkg(inv,item,pkg) pkg.resource = self:GetResource() end

	function ENT:InvMax() return 100 end
	function ENT:GetInvCount() return self:GetResource() end
	function ENT:SetInvCount(value) return self:SetResource(value) end
...
function ENT:DrawInv(item,w,h,butt)
	...
	draw.SimpleText("x" .. item.resource,"InvFont",4,2)
end