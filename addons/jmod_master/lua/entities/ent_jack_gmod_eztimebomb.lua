-- "addons\\jmod_master\\lua\\entities\\ent_jack_gmod_eztimebomb.lua"
	...
	function ENT:Detonate()
		...
		timer.Simple(math.Rand(0, .1), function()
			if IsValid(self) then
				...
				for i,ent in pairs(ents.FindInSphere(SelfPos,512)) do
					if not ent:GetNoDraw() and JMod.IsDoor(ent) then
                        JMod.BlastThatDoor(ent,SelfPos - ent:GetPos())
					end
				end
