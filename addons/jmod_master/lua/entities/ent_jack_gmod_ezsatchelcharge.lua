-- "addons\\jmod_master\\lua\\entities\\ent_jack_gmod_ezsatchelcharge.lua"
...
if SERVER then
	...
	function ENT:Prime()
		...
		timer.Simple(0, function()
			self.Plunger:SetPos(self:GetPos() + Vector(0, 0, 50))
		...
		self.Plunger:PhysicsInit(SOLID_VPHYSICS)
		self.Plunger:SOLID_NONE(SOLID_VPHYSICS)
	end
	...
	function ENT:Use(activator, activatorAgain, onOff)
		...
		if tobool(onOff) then
			...
			if State == JMod.EZ_STATE_OFF and Alt then
				self:Prime()
				timer.Simple(0.1,function() activator:PickupObject(self.Plunger) end)
