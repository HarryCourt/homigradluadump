-- "addons\\jmod_master\\lua\\jmod\\sh_armor.lua"
...
for k,v in pairs(ArmorTableDEF) do JMod.ArmorTable[k] = v end

function JModArmorGenerate()
	JMod.GenerateArmorEntities(JMod.ArmorTable)
end

if Initialize then JModArmorGenerate() end

hook.Add("Initialize","JMod",JModArmorGenerate)
