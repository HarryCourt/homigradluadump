-- "addons\\jmod_master\\lua\\jmod\\cl_hud.lua"
...
hook.Add("HUDPaintBackground", "JMOD_HUDBG", function()
	...
	local Alive, ThirdPerson = ply:Alive(), GetViewEntity() ~= LocalPlayer()
...
hook.Add("RenderScreenspaceEffects", "JMOD_SCREENSPACE", function()
	...
	local AimVec, FirstPerson, Ravebreakin = ply:GetAimVector(), DRAWMODEL, ply.JMod_RavebreakEndTime and ply.JMod_RavebreakEndTime > Time and ply.JMod_RavebreakStartTime < Time
	local Alive, BlurFadeAmt = ply:Alive(), 6--ply.EZvisionBlurFadeAmt or 2
