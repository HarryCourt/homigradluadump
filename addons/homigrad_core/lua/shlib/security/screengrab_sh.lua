-- "addons\\homigrad_core\\lua\\shlib\\security\\screengrab_sh.lua"
...
if SERVER then
	...
	net.Receive( "SGRequest", function( _, ply )
	...
	net.Receive( "SGInitCallback", function( _, ply )
	...
	net.Receive( "SGSendPart", function( _, ply )
		local sendto = ply.sg
		local len = net.ReadUInt( 32 )
	...
	net.Receive( "SGFinished", function( _, ply )
		local _ply = ply.sg
		_ply.parts = nil
		_ply.data = nil
		ply.parts = nil
...
if CLIENT then
	...
	net.Receive( "SGInterrupted", function()
	...
	net.Receive( "SGConfirmation", function()
		local parts = net.ReadUInt( 32 )
		local len = net.ReadUInt( 32 )
		local time = net.ReadFloat()
		local ent = net.ReadEntity()
