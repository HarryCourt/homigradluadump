-- "addons\\vrmod\\lua\\vrmod\\vrmod_dermapopups.lua"
...
function VRUIPopup(panel)
	...
	VRUtilMenuOpen("popup_" .. popupCount,1366,768,panel,4,pos,ang,panel.VRScale or 0.04,true,function()
...
if not VRHMakePopup then VRHMakePopup = meta.MakePopup end

meta.MakePopup = function(...)
	local args = {...}
	VRHMakePopup(unpack(args))
