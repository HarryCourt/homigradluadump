-- "addons\\vrmod\\lua\\vrmod\\vrmod_pickup_arcvr.lua"
...
local function init()
	...
	if CLIENT then
		...
		vrmod.Receive("vrutil_net_pickup",function(len)
		...
		vrmod.Receive("vrutil_net_drop",function(len)
	...
	elseif SERVER then
		...
		vrmod.Receive("vrutil_net_pickup",function(len, ply)
		...
		vrmod.Receive("vrutil_net_drop",function(len, ply)
