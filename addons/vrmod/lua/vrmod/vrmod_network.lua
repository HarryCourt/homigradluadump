-- "addons\\vrmod\\lua\\vrmod\\vrmod_network.lua"
...
elseif SERVER then
	...
	vrmod.Receive("vrutil_net_tick",function(len, ply)
	...
	vrmod.Receive("vrutil_net_join",function(len, ply)
		if g_VR[ply:SteamID()] ~= nil then 
			return 
		end
	...
	vrmod.Receive("vrutil_net_exit",function(len, ply)
	...
	vrmod.Receive("vrutil_net_requestvrplayers",function(len, ply)
