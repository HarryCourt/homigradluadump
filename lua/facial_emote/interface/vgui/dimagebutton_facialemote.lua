-- "lua\\facial_emote\\interface\\vgui\\dimagebutton_facialemote.lua"
...
function PANEL:PaintCircle( w, h ) 
	...
	if ( self.borderSize > 0 ) then
		...
		draw.CircleFacialEmote( w/2, h/2, w/2 + self.zoomVal + self.borderSize, 50 )
	end
	surface.SetDrawColor( self.primaryColor )
	draw.CircleFacialEmote( w/2, h/2, w/2 + self.zoomVal, 50 )
...
derma.DefineControl( "DImageButton_FacialEmote", "Derived DImageButton for facial emote mod", PANEL, "DButton" )
